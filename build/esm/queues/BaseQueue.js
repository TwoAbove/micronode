...
class BaseQueue extends EventEmitter {
    ...
    stopListening() {
        assert(this.listening === true, 'Tried to cancel listening but it was not started');
    ...
    publish(body, properties = {}) {
        assert(this.validateMessageBody(body), ajv.errorsText(this.validateMessageBody.errors));
